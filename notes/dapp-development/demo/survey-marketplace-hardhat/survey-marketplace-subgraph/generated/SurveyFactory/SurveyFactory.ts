...
export class SurveyFactory extends ethereum.SmartContract {
  ...
  try_getAllSurveys(): ethereum.CallResult<Array<Address>> {
    let result = super.tryCall("getAllSurveys", "getAllSurveys():(address[])", []);
    if (result.reverted) {
  ...
  surveyCreationFees(): BigInt {
    let result = super.call("surveyCreationFees", "surveyCreationFees():(uint256)", []);

    return result[0].toBigInt();
  }

  try_surveyCreationFees(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("surveyCreationFees", "surveyCreationFees():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  surveyOwners(param0: Address): SurveyFactory__surveyOwnersResult {
    let result = super.call("surveyOwners", "surveyOwners(address):(address,uint256)", [
      ethereum.Value.fromAddress(param0),
    ]);

    return new SurveyFactory__surveyOwnersResult(result[0].toAddress(), result[1].toBigInt());
  }

  try_surveyOwners(param0: Address): ethereum.CallResult<SurveyFactory__surveyOwnersResult> {
    let result = super.tryCall("surveyOwners", "surveyOwners(address):(address,uint256)", [
      ethereum.Value.fromAddress(param0),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
    ...
    return ethereum.CallResult.fromValue(
      new SurveyFactory__surveyOwnersResult(value[0].toAddress(), value[1].toBigInt()),
    );
  }

  surveys(param0: BigInt): Address {
    let result = super.call("surveys", "surveys(uint256):(address)", [ethereum.Value.fromUnsignedBigInt(param0)]);

    return result[0].toAddress();
  }

  try_surveys(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall("surveys", "surveys(uint256):(address)", [ethereum.Value.fromUnsignedBigInt(param0)]);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
